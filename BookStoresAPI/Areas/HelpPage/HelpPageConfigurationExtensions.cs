...
using BookStoresAPI.Areas.HelpPage.ModelDescriptions;
using BookStoresAPI.Areas.HelpPage.Models;

namespace BookStoresAPI.Areas.HelpPage
{
    public static class HelpPageConfigurationExtensions
    {
        ...
        {
            config.GetHelpPageSampleGenerator().ActionSamples.Add(
        ...
        {
            config.GetHelpPageSampleGenerator().ActionSamples.Add(
                new HelpPageSampleKey(mediaType, SampleDirection.Response, controllerName, actionName, parameterNames),
                sample);
        }
        ...
        public static void SetActualRequestType(this HttpConfiguration config, Type type, string controllerName,
            string actionName)
        {
            config.GetHelpPageSampleGenerator().ActualHttpMessageTypes.Add(
        ...
        private static void LogInvalidSampleAsError(HelpPageApiModel apiModel, object sample)
        {
            ...
            if (invalidSample != null) apiModel.ErrorMessages.Add(invalidSample.ErrorMessage);
        }
    }
}